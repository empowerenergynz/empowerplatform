...
class UpdateAgencyRequestTest extends RequestTestCase
{
    public function setUp(): void
    {
        parent::setUp();
        $this->updatedAgency = Agency::factory()->create();
    }
    ...
    protected function validationTests(): array
    {
        ...
        return [
            ...
            'request_should_pass_when_region_is_valid' => [
                'passed' => true,
                'data' => $this->makeInput([
                    'region_id' => $region->id,
                ]),
    ...
    protected function makeInput(array $overrides = []): array
    {
        ...
        return array_merge([
            ...
            'agency' => $this->updatedAgency,
        ], $overrides);
    }

    protected function makeRequest(array $mockedRequestData): FormRequest
    {
        return new UpdateAgencyRequest($mockedRequestData);
    }
}
